...
import { CustomDataTable, CustomDialog, Icono, IconoTooltip } from "../../common/components/ui";
    ...
    const contenidoTabla: Array<Array<ReactNode>> = lmodulos.map(
        (moduloData, indexModulo) => [
            ...
            <Typography
                ...
                variant={'body2'}
            >{`${moduloData.propiedades?.descripcion ? moduloData.propiedades.descripcion : ''}`}</Typography>,
