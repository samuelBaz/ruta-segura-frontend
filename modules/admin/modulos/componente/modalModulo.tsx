...
import { Box, Button, Checkbox, DialogActions, Grid, Switch } from "@mui/material"
import { useState } from "react"
import { useForm } from "react-hook-form"
import { FormInputDropdown, FormInputText } from "../../../../common/components/ui/form"
...
export const VistaModalModulo = ({
    ...
    const [checked, setChecked] = useState<boolean>(!!modulo?.fidModulo?.id ? false : true);
    ...
    const guardarActualizarModulo = async (
        data: IModulos
    ) => {
    ...
    return (
        <Grid container direction={'column'} justifyContent="space-evenly">
            ...
            {
                checked ? <></> : <Grid container direction="row" spacing={{ xs: 2, sm: 1, md: 2 }}>
