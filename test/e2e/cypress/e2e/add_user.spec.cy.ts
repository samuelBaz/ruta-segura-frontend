...
const rutaDatosUsuarios = '/home/glimachi/projects/python/DatosServiciosFakeSEGIP.ods'
let datos: any[] = []

describe('Add users ', () => {
  before('Load users', () => {
    // @ts-ignore
    cy.task('createUsersFromODS', {pth: rutaDatosUsuarios}).then(usuarios => datos = usuarios)
  })
